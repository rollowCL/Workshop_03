...
public class AddVehicle extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (vehicleDao.vehicleExists(registrationNo)) {
                ...
                request.getRequestDispatcher("/vehicle/vehicleAdd.jsp").forward(request, response);
            } else {
                ...
                if (!constraintViolations.isEmpty()) {
                    ...
                    Vehicle vehicleCreated = vehicleDao.create(vehicle);
                    request.setAttribute("vehicle", vehicleCreated);
                    getServletContext().getRequestDispatcher("/vehicle/vehicleAddSuccess.jsp")
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/vehicle/vehicleAdd.jsp")
                .forward(request, response);
    }
}
