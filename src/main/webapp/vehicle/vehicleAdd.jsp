		...
		<section id="page-title" class="page-title-mini">
			...
			<div class="container clearfix">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><a href="#">Dodaj nowy pojazd</a></li>
				</ol>
			</div>
				...
				<div class="container clearfix">
					...
					<div class="col_full nobottommargin">
						...
						<div class="heading-block nobottomborder">
							<h4>Dodawanie nowego pojazdu dla klienta ${customer.firstName} ${customer.lastName}</h4>
                            ${errors}
						</div>

						<div>

							<form class="row"  action="/addvehicle" method="post">
