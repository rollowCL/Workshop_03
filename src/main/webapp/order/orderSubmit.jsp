		...
		<section id="page-title" class="page-title-mini">
			...
			<div class="container clearfix">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><a href="#">Odbiór pojazdu</a></li>
				</ol>
			</div>
				...
				<div class="container clearfix">
					...
					<div class="col_full nobottommargin">
						...
						<div class="heading-block nobottomborder">
							<h4>Obdiór pojazdu dla naprawy ${order.orderNumber} </h4>
						</div>

						<div>
							<c:if test="${order.statusId eq 5}">
							<form class="row"  action="${pageContext.request.contextPath}/submitorder" method="post">

								<div class="w-100"></div>
									<input type="hidden" id="orderId" name="orderId" value="${order.id}"/>
								<div class="col-12">
									<button type="submit" class="button button-mini button-blue button-3d" value="Submit">Potwiedź obiór</button>
