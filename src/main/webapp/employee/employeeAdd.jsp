		...
		<section id="page-title" class="page-title-mini">
			...
			<div class="container clearfix">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><a href="#">Dodaj nowego pracownika</a></li>
				</ol>
			</div>
				...
				<div class="container clearfix">
					...
					<div class="col_full nobottommargin">
						...
						<div class="heading-block nobottomborder">
							<h4>Dodawanie nowego pracownika</h4>
                            ${errors}
						</div>

						<div>

							<form class="row"  action="${pageContext.request.contextPath}/addemployee" method="post" enctype="multipart/form-data">
								...
								<div class="col-md-6 form-group">
									...
									<input type="text" id="manHourCost" name="manHourCost"
											<c:if test="${empty manHourCostString}"> value="${employee.manHourCost}"</c:if>
											<c:if test="${not empty manHourCostString}"> value="${manHourCostString}"</c:if>
