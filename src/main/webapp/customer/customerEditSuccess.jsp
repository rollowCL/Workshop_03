		...
		<section id="page-title" class="page-title-mini">
			...
			<div class="container clearfix">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><a href="#">Potwierdzenie edycji klienta</a></li>
				</ol>
			</div>
				...
				<div class="container clearfix">
					...
					<div class="col_full nobottommargin">
						...
						<div class="heading-block nobottomborder">
							<h4>Dane klienta ${customer.firstName} ${customer.lastName} zostały zaktualizowane</h4>
						</div>
