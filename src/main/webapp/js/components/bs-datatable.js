...
(function (f) {
    ...
    q.defaults = {
        ...
        oLanguage: {
            oAria: {
                sSortAscending: ": kliknij, żeby posortować rosnąco",
                sSortDescending: ": kliknij, żeby posortować malejąco"
            },
            oPaginate: {
                sFirst: "Pierwsze", sLast: "Ostatnie",
                sNext: "Następne", sPrevious: "Poprzednie"
            },
            sEmptyTable: "No data available in table",
            sInfo: "Wyświetlam pozycje od _START_ do _END_ ze wszytkich _TOTAL_ ",
